...
$_lang['setting_tiny.css_selectors'] = 'CSSスタイルセレクタ';
$_lang['setting_tiny.css_selectors_desc'] = 'class=xxxxxという形で任意のタグに割り当てる「CSSセレクタ」をここで設定できます。<br />書式：'等幅フォント=mono;小さい文字=smallText'<br />上記のように、複数のスタイルをセミコロンで区切って指定します。最後の項目の後ろにはセミコロンを付けないでください。';
...
$_lang['setting_tiny.editor_theme'] = 'テーマ';
