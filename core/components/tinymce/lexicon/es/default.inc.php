...
$_lang['setting_tiny.custom_plugins_desc'] = 'Enter the plugins to use for the 'custom' theme as a comma separated list.';
$_lang['setting_tiny.editor_theme'] = 'Theme';
...
$_lang['area_advanced-theme'] = 'Advanced';
